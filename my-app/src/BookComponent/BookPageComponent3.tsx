...
const BookPageComponent3: React.FC<NewComponentProps> = () => {
  ...
  const [isAvailable, setIsAvailable] = useState(
    localStorage.getItem("Component3 - isAvailable") === "true"
  );

  //useEffect that is used for saving the user input, and if the book is available on the bookstore
  useEffect(() => {
    localStorage.setItem("Component3 - pagesRead", pagesRead.toString());
    localStorage.setItem("Component3 - isAvailable", isAvailable.toString());
...
export default BookPageComponent3;
